...
function abrirFichaAtendimento() {
    alert('🏥 Abrindo Ficha de Atendimento...\n\n(Funcionalidade em desenvolvimento)');
}

function abrirEvolucao() {
    alert('📝 Abrindo Evolução Médica...\n\n(Funcionalidade em desenvolvimento)');
}
...
function gerarReceita() {
    alert('💊 Gerando Receita Médica...\n\n(Funcionalidade em desenvolvimento)');
}

function gerarExames() {
    alert('🔬 Gerando Solicitação de Exames...\n\n(Funcionalidade em desenvolvimento)');
}

function abrirEvolucaoData(data) {
    alert(`📅 Abrindo evolução da data: ${data}\n\n(Funcionalidade em desenvolvimento)`);
}
